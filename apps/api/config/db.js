...
const sequelize = new Sequelize(
  ...
  process.env.DB_PASSWORD || "",
  {
    ...
    dialect,
    // Resolve drivers from this workspace instead of relying on Sequelize's
    // location in a hoisted monorepo node_modules tree.
    dialectModule: useSQLite ? require("sqlite3") : require("mysql2"),
